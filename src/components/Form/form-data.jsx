...
const FormData = ({ onClose }) => {
    ...
    return (
        <div
            className={`fixed z-50 inset-0 flex items-center justify-center left-5 right-5 transition-opacity duration-300 ${
                isVisible ? "opacity-100" : "opacity-0"
            }`}
        >
            <div
                className={`fixed top-0 right-0 h-full w-full backdrop-blur ${
                    isVisible ? "opacity-100" : "opacity-0"
            ...
            >
                <div className="w-full">
                    <div className="p-2">
                        <form
                            className="gap-y-6 pb-24 p-6 items-start"
                        ...
                        >
                            ...
                            />
                            <select
                                className="bg-transparent border-rose-500 border-b py-3 outline-none w-full placeholder:text-slate-950 focus:border-accent transition-all"
