...
function KelapaDua() {
  ...
  const kelapadua = {
    ...
    title: "IndiHome Kelapa Dua Tangerang",
    pageTitle:
      "IndiHome Kelapa-Dua Tangerang | Pendaftaran Online Indihome Area Kelapa-Dua",
    description:
      "IndiHome Kelapa Dua Tangerang kini menyediakan pendaftaran online yang mudah dan praktis untuk semua kebutuhan internet Anda, baik di rumah, kantor, maupun tempat usaha. Dengan gadget Anda, langsung hubungi marketing resmi IndiHome dan nikmati layanan internet terbaik dan segera daftar untuk menikmati koneksi internet terbaik di Kelapa Dua.",
    conten: "kelapadua",
  ...
  return (
    <>
      ...
      {loading ? (
        ...
        <>
          <Banner title={kelapadua.title} description={kelapadua.description} />
          <InternetPromo
