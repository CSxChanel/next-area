...
function KelapaDua () {
    ...
    const pageUrl = `${process.env.NEXT_PUBLIC_WEBSITE_URL}/${kelapadua.path}`;
    
    const ogImage = `${process.env.NEXT_PUBLIC_WEBSITE_URL}/${kelapadua.path}/image1.png`;
    ...
    return (
        ...
        <script type="application/ld+json">
            ...
            <InternetPromo title={kelapadua.title} path={kelapadua.path} onClick={kelapadua.onClick} buttonLabel={kelapadua.buttonLabel} />
            <MapImage />
            <BannerImgSlider />
        </>
    )
