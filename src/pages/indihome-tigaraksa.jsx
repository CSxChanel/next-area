...
function Tigaraksa () {
    ...
    const tigaraksa = {
        ...
        description: 'Untuk Sobat indihome wilayah Indihome-tigaraksa dapat Registrasi atau Pendaftaran Online juga bisa menghubungi Marketing resmi indihome. ada banyak pilihat paket promo untuk wilayah tigaraksa.',
        conten: 'tigaraksa',
    ...
    const pageUrl = `${process.env.NEXT_PUBLIC_WEBSITE_URL}/${tigaraksa.path}`;
    
    const ogImage = `${process.env.NEXT_PUBLIC_WEBSITE_URL}/${tigaraksa.path}/image1.png`;
