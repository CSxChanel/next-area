...
function Tigaraksa() {
  ...
  const tigaraksa = {
    ...
    title: "IndiHome Tigaraksa Tangerang",
    pageTitle:
      "IndiHome area Tigaraksa Tangerang | Pendaftaran Online area tigaraksa",
    description:
      "Untuk Sobat indihome area wilayah Indihome tigaraksa dapat Registrasi atau Pendaftaran Online juga bisa menghubungi Marketing resmi indihome. ada banyak pilihat paket promo untuk wilayah tigaraksa. yuk daftarkan dirimu sekarang.",
    conten: "tigaraksa",
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:description" content={tigaraksa.description} />
        ...
        <meta name="twitter:description" content={tigaraksa.description} />
      ...
      {loading ? (
        ...
        <>
          <Banner title={tigaraksa.title} description={tigaraksa.description} />
          <InternetPromo
          ...
          <LanggananSekarang title={tigaraksa.title} />
          <MapImage />
          <BannerImgSlider />
          <BantuanIndihome title={tigaraksa.title} />
          <Qne
            title={tigaraksa.title}
            titleLink="https://indihome-area.com/indihome-tigaraksa"
          />
        </>
      )}
    </>
