...
function PasarKemis () {
    ...
    const pasarkemis = {
        ...
        description: 'Registrasi IndiHome Pasar Kemis kini semakin mudah dan cepat dengan sistem pendaftaran online. Hanya dengan menggunakan gadget, Anda bisa menghubungi marketing resmi IndiHome untuk pemasangan di rumah, kantor, atau tempat usaha Anda. Jangan lewatkan kesempatan ini, daftar IndiHome sekarang juga!',
        conten: 'pasarkemis',
    ...
    const pageUrl = `${process.env.NEXT_PUBLIC_WEBSITE_URL}/${pasarkemis.path}`;
    
    const ogImage = `${process.env.NEXT_PUBLIC_WEBSITE_URL}/${pasarkemis.path}/image1.png`;
