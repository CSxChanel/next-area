...
const PromoIndihome = () => {
  ...
  return (
    <>
      <Head>
        <title>Indihome-Area | Promo IndiHome - Penawaran Spesial Layanan Internet, TV, dan Telepon</title>
        <meta
          name="description"
        ...
        <meta property="og:title" content="Indihome-Area || Promo IndiHome - Penawaran Spesial Layanan Internet, TV, dan Telepon" />
        <meta
        ...
        <meta name="twitter:title" content="Indihome-Area || Promo IndiHome - Penawaran Spesial Layanan Internet, TV, dan Telepon" />
        <meta
          name="twitter:description"
          content="Nikmati berbagai promo menarik dari IndiHome untuk layanan internet, TV interaktif, dan telepon rumah. Dapatkan harga spesial, diskon menarik, dan berbagai keuntungan lainnya dengan mendaftar promo IndiHome sekarang. Promo IndiHome hadir untuk memberikan pengalaman digital terbaik dengan biaya yang lebih terjangkau. Cek promo terbaru dan segera daftar untuk menikmati koneksi internet cepat, tayangan TV berkualitas, dan layanan telepon rumah dari IndiHome."
        />
        <meta name="twitter:image" content={ogImage} />
        <meta name="keywords" content="indihome, internet, promo-indihome, pendaftaran, indihome-cikupa, indihome-balaraja, indihome-tigaraksa" />
                  {/* Robots meta tags */}
