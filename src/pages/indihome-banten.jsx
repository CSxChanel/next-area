...
function Banten () {
    ...
    const banten = {
        ...
        description: 'Untuk Sobat indihome wilayah Banten dapat melakukan Registrasi atau Pendaftaran Online, juga bisa menghubungi Marketing resmi indihome. ada banyak pilihat paket promo untuk wilayah IndiHome-Banten.',
        conten: 'banten',
    ...
    const pageUrl = `${process.env.NEXT_PUBLIC_WEBSITE_URL}/${banten.path}`;
    
    const ogImage = `${process.env.NEXT_PUBLIC_WEBSITE_URL}/${banten.path}/image1.png`;
    ...
    return (
        ...
        <InternetPromo title={banten.title} path={banten.path} onClick={banten.onClick} buttonLabel={banten.buttonLabel} />
        <MapImage />
        <BannerImgSlider /> 
