...
function Rajeg() {
  ...
  const rajeg = {
    ...
    pageTitle:
      "IndiHome area Rajeg Tangerang | Pendaftaran Online area indihome rajeg",
    description:
      "IndiHome area Rajeg tangerang hadir dengan kemudahan pendaftaran online untuk memenuhi kebutuhan internet Anda di rumah, kantor, atau tempat usaha. Tanpa perlu repot, Anda dapat langsung menghubungi marketing resmi IndiHome melalui gadget Anda. yuk, Segera daftar dan nikmati layanan internet terbaik dari IndiHome Rajeg.",
    conten: "rajeg",
    ...
    <>
      ...
      {loading ? (
        ...
        <>
          ...
          <Qne
            title={rajeg.title}
            titleLink="https://indihome-area.com/indihome-rajeg"
          />
        </>
      )}
    </>
